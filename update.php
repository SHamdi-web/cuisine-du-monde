...
<title>Cuisine du monde</title>
	<link rel="stylesheet" type="text/css" href="css_update.css">
                ...
                <div class="col-sm-6">
                    ...
                    <form class="form" role="form" action="<?php echo 'update.php?id=' . $id; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-actions">
                            <div class="btn-success popup btn" onclick="myFunction()"> <span class="glyphicon glyphicon-pencil"></span> Modifier
